      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {latest?.map(listing => (
            ...
            to={`cars/${listing._id}`}
              key={listing._id}
              className="bg-card rounded-lg shadow-lg hover:shadow-xl transition-all  duration-300 transform hover:scale-105">
              <img
                src={listing.image}
                alt={listing.model}
              ...
              <div className="p-4">
                ...
                <p className="text-sm text-text mb-2"><span className='font-bold'>${listing.price}</span>/day</p>
