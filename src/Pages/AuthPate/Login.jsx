...
function Login() {
  ...
  return (
    <section className="bg-cover bg-center flex justify-center items-center">
      ...
      <div className="wrap overflow-hidden border grid grid-cols-1 justify-center items-center xl:grid-cols-2 my-20 rounded-2xl">
        <Slide>
          <Fade duration="300">
            <Lottie loop={true} animationData={animation} />
          </Fade>
        </Slide>{' '}
        <Slide Slide direction="right">
          <Fade duration="300">
            <div className="w-full m-auto rounded-lg shadow dark:shadow-stone-300 sm:max-w-md xl:p-0 bg-bg border-base-300">
              <div className="p-6  overflow-hiddenspace-y-4 md:space-y-6 sm:p-8">
                ...
                <form
                  ...
                  <div>
                    ...
                    <Link
                      ...
                      to="/reset">
                      <small className="hover:text-pin/50">
                        Forget Password
                      </small>
                    </Link>
                  </div>
